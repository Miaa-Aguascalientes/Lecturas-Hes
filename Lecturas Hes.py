...
# Aseguramos que ClientID_API y otros campos se mantengan al agrupar
mapeo_columnas = {
    'Consumo_diario': 'sum', 
    'Lectura': 'last', 
    'Latitud': 'first', 
...
# Verificamos qué columnas existen realmente en df_hes antes de agrupar
